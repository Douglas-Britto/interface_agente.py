...
with st.expander("🧾 Resumo Automático com IA"):
    ...
    if st.button("Gerar Resumo com IA") and agent:
        historico_texto = ""
    ...
    elif st.button("Gerar Resumo com IA") and not agent:
...
if st.button("💬 Gerar resumo final do agente") and agent:
    if not st.session_state.historico:
        ...
        if salvar_limpar:
            ...
            st.session_state.historico = []
            st.success("✅ Grupo salvo e histórico limpo para próxima pergunta.")
elif st.button("💬 Gerar resumo final do agente") and not agent:
    st.info("Resumo com IA indisponível para arquivos Excel. Use CSV para ativar o agente.")
